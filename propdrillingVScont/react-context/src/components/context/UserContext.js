...
export const useUpdateDrink = () => {
  console.log ("UpdateDrinkContext" + UpdateDrinkContext)
...
export const UserProvider = ({ value, children }) => {
  ...
  return (
    <UserNameContext.Provider value={[userName, drink]}>
      <UpdateUserNameContext.Provider value={{ setUserName, setDrink }}>
        {children}
